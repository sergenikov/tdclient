...
def main(argv):
    ...
    # api_link stores auth key and other client info to keep reconnecting
    # to the Todoist servers for information. Daemon tdd is what actually
    # communicates with servers and also keeps track of activities.
    api_link = read_app_info()
    tdd = TDDaemon(api_link)
